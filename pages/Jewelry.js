...
//pimport { supabase } from "../supabaseClient";
...
const Jewelry = () => {
    ...
    const handleWhatsAppClick = () => {
        ...
        const itemList = cart.map(item => `- ${item.name}: MK${item.price ? item.price: "N/A"} (ID: ${item.id})`).join('\n');
                    ...
                    >
                        ...
                        {item.photo_url ? (
                            <Image
                                ...
                                height={300}
                                layout="responsive"
                                style={{ maxHeight: "230px", paddingTop: "20px" }}
                                quality={90}
                                priority
                            />
                        ) : (
                        ...
                        <div className="product-details">
                            <h3>{item.name}</h3>
                            <p>MK{item.price ? item.price : "N/A"}</p>
                            ...
                            {cart.map((item) => (
                                <div key={item.id} className="cart-item">
                                    ...
                                    <div>
                                        ...
                                        <p>MK{item.price ? item.price : "N/A"} (ID: {item.id})</p>
                                    </div>
                                </div>
                            ))}
                        </div>
